...
class Shop(models.Model):
    ...
    whatsapp = models.URLField(blank=True,null=True,default=None)
    ...
    account_holder_name = models.CharField(max_length=255,null=True,default='..')
    account_number = models.CharField(max_length=255,null=True,default='..')
    account_holder_email = models.EmailField(max_length=255,null=True,default='nil@mail.com')
